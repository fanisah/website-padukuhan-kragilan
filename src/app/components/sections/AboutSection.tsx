...
export default function AboutSection() {
  ...
  return (
    <section id="tentang" className="bg-[#FFF9EC] py-20 lg:py-24">
      <div className="mx-auto grid max-w-7xl items-center gap-12 px-4 sm:px-6 lg:grid-cols-2 lg:px-8">
        ...
        <div className="overflow-hidden rounded-2xl bg-[#F1F3EF]">
          <img src={profile.aboutImageUrl} alt={`Tentang ${profile.name}`} className="h-auto max-h-[480px] w-full object-contain" />
        </div>
      </div>
    </section>
  );
